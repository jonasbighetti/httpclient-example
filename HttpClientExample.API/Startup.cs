using HttpClientExample.API.Configuration;
...
namespace HttpClientExample.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<IPostService, PostService>(x => x.BaseAddress = new Uri(Configuration["ApiConfig:BaseUrl"]));
